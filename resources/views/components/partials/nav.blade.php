        ...
        <div class="flex items-center lg:order-2">
            ...
            <div class="flex space-x-2 md:space-x-8">
                ...
                <a href="{{ route('register') }}"
                    class=" text-white bg-indigo-500 hover:bg-purple-600 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800"
                    :active="request()->routeIs('register')"> Register </a>

                <a href="{{ route('login') }}"
                    class="text-white bg-cyan-700 hover:bg-cyan-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-purple-600 dark:hover:bg-purple-700 focus:outline-none dark:focus:ring-purple-800"
                    :active="request()->routeIs('login')">Login</a>
            </div>
            @endauth
